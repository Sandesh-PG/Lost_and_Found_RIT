        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 font-sans">
            ...
            <div className="w-full max-w-2xl">
                <header className="mb-6">
                    <Link to="/lost" className="flex items-center gap-2 text-gray-500 hover:text-blue-600 transition-colors font-medium">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                    ...
                    <p className="text-center text-gray-500 mb-8">Please fill out the details below to report an item you've lost.</p>
                    ...
                    <form onSubmit={handleSubmit} onReset={handleReset} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label htmlFor="location" className="block text-sm font-medium text-gray-700 mb-1">Location Lost</label>
                                <input
                                    type="text"
                                    id="location"
                                    name="location"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label htmlFor="date" className="block text-sm font-medium text-gray-700 mb-1">Date Lost</label>
                                <input
                                    type="date"
                                    id="date"
                                    name="date"
